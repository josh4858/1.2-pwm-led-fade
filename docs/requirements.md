...
| REQ-002 | Functional | The LED brightness shall transition continuously from off to full brightness with no visible stepped transitions | Demonstration | Draft |
| REQ-004 | Functional | The LED shall fade from off to full brightness, then back to off, in one continuous cycle of 3 seconds | Demonstration | Draft |
